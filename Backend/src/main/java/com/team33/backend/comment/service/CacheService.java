...
public class CacheService {
    ...
    @Transactional
    public List<CommentCache> findCommentCacheByIssueId(Long issueId) {
        List<CommentCache> findCommentCaches = commentQueryRepository.findCommentsByIssueId(issueId);
